...
document.addEventListener('DOMContentLoaded', async function() 
{
    ...
    async function() 
    {
        document.getElementById("lite-sub-button").addEventListener('click',
        function()
        {
            window.location.href = '/pages/v2/auth/';
        });
        document.getElementById("basic-sub-button").addEventListener('click',
        function()
        {
            window.location.href = '/pages/v2/auth/?referal=subscriptions-home&action=sub&key=basic';
        });
        document.getElementById("premium-sub-button").addEventListener('click',
        function()
        {
